...
- **Use absolute imports** from `src/` for all cross-folder imports (e.g., `import { X } from "src/models/types"`). Use relative imports only for same-folder files (CSS modules, index re-exports).
