...
describe("<ScorePicker />", () => {
  ...
  it("marks the selected value as pressed", () => {
    render(
      <ScorePicker availableValues={[15, 14]} selectedValue={15} onPick={vi.fn()} />,
    );
  ...
  it("calls onPick with the value when clicking an unselected button", () => {
    const onPick = vi.fn();
    render(
      <ScorePicker availableValues={[15]} selectedValue={null} onPick={onPick} />,
    );
  ...
  it("renders no buttons when availableValues is empty", () => {
    render(
      <ScorePicker availableValues={[]} selectedValue={null} onPick={vi.fn()} />,
    );
